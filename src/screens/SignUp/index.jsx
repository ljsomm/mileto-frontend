            ...
            switch (step) {
              case 1:
                if (
                  ...
                  if (
                    parseInt(birthDate[1]) > actualDate.getMonth() + 1 ||
                    (parseInt(birthDate[1]) === actualDate.getMonth() + 1 &&
                      parseInt(birthDate[2]) > actualDate.getDate())
                  ) {
                    age--;
                  }
                  if (age < 14) {
                  ...
                  user.name === ""
                    ? (nameRef.current.style =
                        "border-bottom-color: red; color: red;")
                    : (nameRef.current.style = null);
                  user.lastname === ""
                    ? (lastnameRef.current.style =
                        "border-bottom-color: red; color: red;")
                    : (lastnameRef.current.style = null);
                  user.birthDate === ""
                    ? (birthDateRef.current.style =
                        "border-bottom-color: red; color: red;")
                    : (birthDateRef.current.style = null);
                ...
                if (
                  ...
                  if (user.email.includes("@")) {
                    if (user.password === user.passwordConfirmation) {
                      ...
                      passwordConfirmationRef.current.style =
                  ...
                  user.passwordConfirmation === ""
                    ? (passwordConfirmationRef.current.style =
                        "border-bottom-color: red")
                    : (passwordConfirmationRef.current.style = null);
                  setError("Preencha a todos os campos corretamente!");
                }
                break;
              case 3:
                if (user.abbreviation !== "") {
                  ...
                  if (user.abbreviation === "O") {
                    if (user.treatment !== "" && user.custom !== "") {
                      ...
                      customRef.current.style =
                        user.custom === "" ? "border-bottom-color: red" : null;
                      treatmentRef.current.style =
                        user.treatment === ""
                          ? "border-bottom-color: red"
                          : null;
                      setError("Preencha a todos os campos corretamente!");
                ...
                return (
                  <>
                    ...
                    <input
                      ...
                      name="inp-confirmacao-senha"
                      id="inp-confirmacao-senha"
                      onChange={(e) => {
                        e.target.style =
                          e.target.value === ""
                            ? "border-bottom-color: red"
