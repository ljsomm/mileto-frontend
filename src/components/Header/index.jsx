  ...
  return (
    <header
      style={(() => {
        if (pathname === "/") {
          return {
            backgroundColor: `rgba(55, 74, 79, ${parseFloat(bgColor) / 350})`,
          };
        } else if (pathname === "/login" || pathname === "/cadastro") {
          return { display: "none" };
        }
      })()}
      className={pathname === "/" ? "home-header" : "default-header"}
    >
      <div className="header-put">
        <Link to="/">
          <img
            src={pathname === "/" ? LogoHome : LogoDefault}
            alt="logo"
        ...
        if (pathname !== "/") {
          return (
            <>
              ...
              <div>
                <input
                  placeholder="Pesquise por cursos que goste"
                  type="search"
                  name="header-search"
                  id="header-search"
                />
      ...
      {cookies.__token ? (
          ...
          <div className="end-header">
            ...
            >
              <img
                alt="User"
                className="user-icon"
                src={UserUtil.imageSrcFilter(state.Images[0].path)}
              />
            ...
            {menu && (
              ...
              >
                <ol>
                  ...
                  <li onClick={() => navigate("/meus-cursos?page=1")}>
                    Meus Cursos
                  </li>
        ...
        <div
          className={`${pathname === "/" ? "home" : "default"}-header-buttons`}
        >
          <button
